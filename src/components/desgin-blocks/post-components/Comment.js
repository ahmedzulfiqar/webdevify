      ...
      <div class="d-flex comment flex-start   mb-md-3 mb-4 ">
        ...
        <div className="d-md-block d-none ">
          ...
          <div className="d-flex p-0 m-0 mt-2">
            ...
            <div
              className="text-purple ms-md-2 ms-1"
              onClick={() => setshowreply(!showreply)}
            >
              {!showreply ? "Show Reply" : "Hide Reply"}
            </div>
          </div>
        </div>{" "}
        <div className="d-md-none d-block ">
          ...
          <div className="d-flex p-0 m-0 mt-2">
            ...
            <div className="text-purple ms-md-2 ms-1 small"     onClick={() => setshowreply(!showreply)}>{!showreply ? "Show Reply" : "Hide Reply"}</div>
          </div>
        </div>
      </div>
      {showreply && (
